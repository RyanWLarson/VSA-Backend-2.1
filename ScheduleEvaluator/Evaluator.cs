...
namespace ScheduleEvaluator
{
    ...
    public class Evaluator
    {
        ...
        // in paramaters.
        public static readonly CritTyp[] criteriaTypes = { CritTyp.CoreCreditsAQuarter, CritTyp.MaxQuarters, CritTyp.CoreClassesLastYear, CritTyp.MajorSpecificBreaks, CritTyp.MathBreaks };
        public static readonly double[] weights = { 1.0, 1.0, 3.0, 3.0, 3.0 };
